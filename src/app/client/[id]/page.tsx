      ...
      <div className="container shadow-md rounded p-4 my-7 mb-4">
          ...
          <div>
            <div className="grid grid-cols-2 space-x-6">
              ...
              <div className="flex items-center">
                <Link href={`/interviews/edit/${id}`} className="bg-green-500 py-1 px-2 rounded-tl-md rounded-bl-md border-r-2 no-underline text-white">
                  Redigera
                </Link>
                <button onClick={() => handleDelete()} className="bg-red-500 py-1 px-2 rounded-tr-md rounded-br-md no-underline text-white">Ta Bort</button>
              </div>
            </div>
          </div>
          <div></div>
        ...
        <div className="grid grid-cols-2 gap-7 w-full mt-5">
          <div className="col bg-slate-200 p-3 rounded">
            ...
            <p className="text-sm">Sammanfattning och bakgrundsinformation - Utlåtande.</p>
          </div>
          <div className="col bg-slate-200 p-3 rounded">
            ...
            <p className="text-sm">Tar upp de vanligaste preparaten och läkemedlen.</p>
          </div>
          <div className="col bg-slate-200 p-3 rounded">
            <div className="flex justify-between mb-3">
              <h3 className="text-lg">ICD10 Pedagogisk Checklista</h3>
              <Link href="/client/id/pedagogicchecklist">Checklista</Link>
            </div>
            <p className="text-sm">
          ...
          <div className="col bg-slate-200 p-3 rounded">
            <div className="flex justify-between mb-3">
              ...
              <div className="space-y-2 flex flex-col items-center">
                <Link href="/client/id/diagnos/dsm5/checklist">DSM5</Link>
            ...
            <p className="text-sm">Sammanställning av resultat och underlag för diagnos.</p>
          </div>
          <div className="col bg-slate-200 p-3 rounded">
            <div className="flex justify-between mb-3">
